<template>
  <div class="password_body">
    <div class="password_email">
      <input v-model="email" class="password_text" placeholder="邮箱" type="text" />
      <button :disabled="disabled" @touchstart="handleToVerify">{{verifyInfo}}</button>
    </div>
    <div>
      <input v-model="password" class="password_text" placeholder="新密码" type="password" />
    </div>
    <div>
      <input v-model="verify" class="password_text" placeholder="验证码" type="text" />
    </div>
