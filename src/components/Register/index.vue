<template>
  <div class="register_body">
    <div class="register_email">
      <input placeholder="邮箱" v-model="email" class="register_text" type="text" />
      <button :disabled="disabled" @touchstart="handleToVerify">{{verifyInfo}}</button>
    </div>
    <div>
      <input placeholder="用户名" v-model="username" class="register_text" type="text" />
    </div>
    <div>
      <input placeholder="密码" v-model="password" class="register_text" type="password" />
    </div>
    <div>
      <input placeholder="确认密码" class="register_text" type="password" />
    </div>
    <div>
      <input placeholder="验证码" v-model="verify" class="register_text" type="text" />
    </div>
